...
class TransactionItem(
...
) : RecyclerView.Adapter<TransactionItem.ProductViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TransactionItem.ProductViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.transaction_pruduct_item, parent, false)
